...
const CodeOfConduct = ({type='regular'}) => {
    ...
    return (
        <div className='code-of-conduct'>
            ...
            <p>Read <a target="_blank" href="https://stefan3002.github.io/CodeLighthouse-Docs/community-code-of-conduct.html"><b>full Code of Conduct</b></a>.</p>
        </div>
    )
    else
        if(type === 'chat-bot')
                ...
                <div className='code-of-conduct'>
                    ...
                    <ol>
                        <li>
                            <strong>Be Respectful</strong>
                            <br/>
                            Respect and ask your questions for Llama in a civilised manner. Please, do not upset Llama!
                        </li>
                        <li>
                            <strong>Do not ask for solutions</strong>
                            <br/>
                            Under no circumstance Llama is allowed to give you the full solution to you coding challenge. Only ask about general CS problems.
                        </li>
                    </ol>
